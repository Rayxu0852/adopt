                ...
                <ul>
                    ...
                    <c:if test="${!flage}" var="flage" scope="session">
                        <li id="login_register">
                            <button class="btn-primary btn-lg" data-toggle="modal" data-target="#login">signup/login</button>
                        </li>
                    </c:if>
                </ul>
            </div>
                    ...
                    <div role="tabpanel">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active">
                                <a href="#home" aria-controls="login" role="tab" data-toggle="tab">login</a>
                            </li>
                            <li role="presentation">
                                <a href="#tab" aria-controls="register" role="tab" data-toggle="tab">signup</a>
                            </li>
                        </ul>
                    </div>
                </h5>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    <div class="modal-body">
                        <form class="form-horizontal" id="user_login_form">
                            <div class="form-group">
                                <label for="new_loginName" class="col-sm-2 control-label">account</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="new_loginName" placeholder="account"
                                           name="userName">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="new_loginPwd" class="col-sm-2 control-label">password</label>
                                <div class="col-sm-8">
                                    <input type="password" class="form-control" id="new_loginPwd" placeholder="password"
                                           name="password">
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn-primary btn-lg" id="user_login_btn">login</button>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane" id="tab">
                    <div class="modal-body">
                        <form class="form-horizontal" id="user_register_form" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_userName" placeholder="user name"
                                           name="userName">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_password" placeholder="user password"
                                           name="password">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_telephone" placeholder="telephone"
                                           name="telephone">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="new_address" placeholder="address"
                                           name="address">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="new_state" name="state">
                                        <option value="0">has adopt experience</option>
                                        <option value="1">no adopt experience</option>
                                    </select>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class=" btn-primary" id="user_register_btn">signup</button>
                    </div>
                </div>
            </div>
        </div><!-- /.modal-content -->
