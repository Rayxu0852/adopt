...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Pet adoption admin backstage</title>
    <!-- 引入css样式文件 -->
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            <a class="navbar-brand" href="">Homeless pets manage system</a>
        </div>
        <!-- 导航栏右侧图标部分 -->
        <!-- 导航栏右侧图标部分 -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user ">
                    ...
                    <li><a href="/admin/developing"><i class="fa fa-user fa-fw"></i>
                        Admin：${admin.adminName}</a>
                    </li>
                    <li><a href="/admin/developing"><i class="fa fa-gear fa-fw"></i> System Setting</a></li>
                    <li class="divider"></li>
                    <li>
            ...
            <div class="sidebar-nav navbar-collapse">
                ...
                <div class="panel-heading" id="collapseListGroupHeading3" data-toggle="collapse" data-target="#collapseListGroup3" role="tab">
                    <h4 class="panel-title">
                        backstages  <span class="fa fa-chevron-up right"></span>
                    </h4>
                </div>
                    ...
                    <ul class="list-group">
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/user">
                                <i class="fa fa-flash fa-fw"></i> User info
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/admin">
                                <i class="fa fa-flash fa-fw"></i> Admin info
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/pet">
                                <i class="fa fa-sitemap fa-fw"></i> Pets management
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/adopt">
                                <i class="fa fa-sitemap fa-fw"></i> Adoption management
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/comment">
                                <i class="fa fa-sitemap fa-fw"></i> Comment management
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/blog">
                                <i class="fa fa-sitemap fa-fw"></i> Team activities management
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/apply">
                                <i class="fa fa-sitemap fa-fw"></i> Volunteer Applying
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/agree">
                                <i class="fa fa-sitemap fa-fw"></i> Adoption agreement list
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${path}/admin/disAgree">
                                <i class="fa fa-sitemap fa-fw"></i> Adoption unagreement list
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="panel-body">
                <form class="form-inline" method="get" >
                    <div class="form-group">
                        <label for="findByName">Admin name</label>
